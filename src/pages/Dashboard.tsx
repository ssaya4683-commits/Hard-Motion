...
export function Dashboard() {
  ...
  const stats = [["Total Produk", summary.totalProducts, Package], ["Total Stok", summary.totalStock, Boxes], ["Inventory Value", formatCurrency(summary.inventoryValue), Activity], ["Low Stock Count", summary.lowStock, AlertTriangle]] as const;
